  ...
  return (
    <div data-role="header-status" ref={rootRef}>
      ...
      <div
        ...
        aria-hidden={!open}
      >
        {/* No head over the list. The panel only ever opens from the button that
            already says what it holds, and the rows carry their own marks — a
            line reading "Tickets" above them named the list a second time and
            spent the panel's first 42px doing it. The tickets start at the top. */}
